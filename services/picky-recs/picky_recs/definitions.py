...
from picky_recs.assets.training import training_data
...
defs = Definitions(
    assets=[customer_vectors, training_data, trained_model, seed_synthetic_users, recipe_collection, recipe_vectors],
